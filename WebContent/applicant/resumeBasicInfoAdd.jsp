...
<div class="resume_con">
    ...
    <div class="resume_main">
	    ...
	    <div class="resume_left">
			...
			<form action="../resumeBasicInfoServlet" method="post" onsubmit="return validate();">
				<div class="table_style">
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    <th width="110" align="right" bgcolor="#F8F8F8">姓名：</th>
					    <td bgcolor="#F8F8F8"><input type="text" name="realName" id="realName" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					...
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="birthday" id="birthday" onclick="SelectDate(this)" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="currentLoc" id="currentLoc" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="residentLoc" id="residentLoc" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="telephone" id="telephone" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="email" id="email" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
					  <tr>
					    ...
					    <td bgcolor="#F8F8F8"><input type="text" name="jobIntension" value=""></td>
					  </tr>
					</table>
					<div class="he"></div>
					<table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#EEEEEE">
