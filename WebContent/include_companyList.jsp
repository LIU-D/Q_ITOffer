...
<!-- 招聘企业展示 -->
    <c:forEach var="company" items="${pagination.pageData }">
      <div class="tn-grid">
  	  ...
  	  <!-- 翻页 -->
  	  <div class="page01">
  	  	<div class="page03"><a href="index.jsp?action=pageList&pageNo=1">首页</a></div>
  	  	<%if(pagination.isHasPreviousPage()){ %>
  	  	<div class="page03">
  	  		<a href="index.jsp?action=pageList&pageNo=<%=pagination.getPageNo() - 1 %>">上一页</a>
  	  	</div>
		<%} %>
		<%if(pagination.isHasNextPage()){ %>
  	  	<div class="page03">
  	  		<a href="index.jsp?action=pageList&pageNo=<%=pagination.getPageNo() + 1 %>">下一页</a>
  	  	</div>
		<%} %>
		<div class="page03">
  	  		<a href="index.jsp?action=pageList&pageNo=<%=pagination.getTotalPages() %>">尾页</a>
  	  	</div>
