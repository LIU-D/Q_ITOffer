      ...
      <div class="job">
        <table class="it-table">
          <tbody>
            <tr>
              ...
              <td class="tn-border-rb"> ${requestScope.job.hiringNum } </td>
              <td class="it-table-title"> 薪资： </td>
              <td class="tn-border-rb"> ${requestScope.job.salary } </td>
            </tr>
            <tr>
              <td class="it-table-title"> 工作地区： </td>
              <td class="tn-border-rb"> ${requestScope.job.area } </td>
              <td class="it-table-title"> 结束日期： </td>
              <td class="tn-border-rb"> ${requestScope.job.endTime } </td>
            </tr>
          </tbody>
        </table>
        <div class="it-post-count">
          ...
          <ul class="tn-text-note it-text-part">
            ...
            <li class="jobli"><span class="tn-explain-icon"><span class="tn-icon it-icon-people"></span><span class="tn-icon-text">招聘人数 <span class="it-font-cor">${requestScope.job.hiringNum }</span> 人</span></span></li>
...
<!--         <div class="it-post-text">
        ...
        <div class="it-post-text">
          <p><strong>岗位描述：</strong> ${requestScope.job.desc }</p>
      <!--     <p><strong>任职资格：</strong></p>
        ...
        <div class="btn_bot"> <a class="tn-button-secondary" href="companyServlet?action=info&id=${requestScope.company.id}" target="_blank"> <span style="color:#1faebc"  class="tn-button-text">查看公司信息</span> </a> <a title="您已经申请过！" class="tn-button-secondary" href="javascript:void(0)"> <span class="tn-button-text">此职位已经申请</span> </a> </div>
      </div>
    </div>
    <div class="job_right">
